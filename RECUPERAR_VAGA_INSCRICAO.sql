/*
/*FNDE - prorrogação de prazo - FIES - Sisfies Aluno
Ordem de trabalho # WO1330706*/

/*===========================================================================================================================*/
SET SERVEROUTPUT ON;
DECLARE        
    --PARAMETRO DE ENTRADA
    P_NU_CPF                     VARCHAR2(11):= '07876739350'; 
    P_CO_INSCRICAO               NUMBER(10)  := 204515371;    
    P_CO_USUARIO                 NUMBER(10)  := 6591199;    
    P_TP_USUARIO                 NUMBER(1)   := 2; 
    ...
    P_CO_SITUACAO_FINANCIAMENTO  NUMBER(2)   := 2; -- Validado pela CPSA
    ...
    ----|INICIO
		...
		*/
            ...
            */
            ...
            VALUES ( FIES_FINANCIAMENTO.SQ_H_FIN_CANDIDATO_PUBLICO.NEXTVAL, V_CO_USUARIO, P_CO_SITUACAO_FINANCIAMENTO, NULL, SYSDATE , 1   );

 -- INSERIR VAGA PARA ESTUDANTE QUE NUNCA OCUPOU VAGA NO CURSO SELECIONADO 2.1
...
DECLARE
    ...
    P_CO_INSCRICAO               NUMBER(10)  := 90439996;
    P_TP_USUARIO                 NUMBER(1)   := 1; --REGULAR OU REMANESCENTE
    P_TP_VAGA                    NUMBER(1)   := 1; --PUBLICO
    P_CO_SEMESTRE_FINANCIAMENTO  NUMBER(5)   := 20191;
...
----|INICIO
    ...
    BEGIN
        ...
        FROM (
                    ...
                    WHERE CO_USUARIO = P_CO_USUARIO AND NU_ABA = 4 ORDER BY DT_OPERACAO_LOG desc
             )
        WHERE ROWNUM = 1;

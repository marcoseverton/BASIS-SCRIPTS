...
SET SERVEROUTPUT ON;
DECLARE        
    --[JUDICIAL] #21044 – Aluno: CHARLES WILLIAM TEIXEIRA DA SILVA – CPF: 03667617224
    --PARAMETRO DE ENTRADA
    P_NU_CPF                     VARCHAR2(11):= '03667617224'; 
    P_CO_INSCRICAO               NUMBER(10)  := 12618235;
    P_CO_USUARIO                 NUMBER(10)  := 10856379;    
    P_TP_USUARIO                 NUMBER(1)   := 1; --REGULAR
    P_TP_VAGA                    NUMBER(1)   := 1; --PUBLICO
    P_CO_SEMESTRE                NUMBER(5)   := 20191;
    P_CO_SEMESTRE_FINANCIAMENTO  NUMBER(5)   := 20191;
    P_CO_SITUACAO_INSCRICAO      NUMBER(2)   := 3; -- Validado pelo MEC
    P_CO_SITUACAO_FINANCIAMENTO  NUMBER(2)   := 3; 

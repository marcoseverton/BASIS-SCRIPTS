/*===========================================================================================================================*/
/* - ORACLE - DERRUBAR INSCRICAO
CIRLANE BEZERRA DA SILVA - CPF: 067.125.954-79
LUIS JORGE DA COSTA      - CPF: 972.999.793-49
*/
...
BEGIN
    ...
    (        
        ...
        AND         CO.CO_SEMESTRE         = 20181
        AND         PF.NU_CPF IN ( '06712595479', '97299979349' )              
    )
    LOOP 
        BEGIN   
        ----|INICIO                    
